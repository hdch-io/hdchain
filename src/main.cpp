...
#if defined(NDEBUG)
# error "HDCH Core cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "HDCH Signed Message:\n";
...
bool static AlreadyHave(const CInv& inv) EXCLUSIVE_LOCKS_REQUIRED(cs_main)
{
    ...
    /* 
        HDCH Related Inventory Messages
