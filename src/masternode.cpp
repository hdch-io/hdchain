...
bool CMasternodeBroadcast::getPubKeyId(CKeyID& pubKeyId)
{
    ...
    {
        LogPrintf("CMasternodeBroadcast::getPubKeyId -- masternode collateraloutputtxid is empty, please set it in hdch.conf\n");
        return false;
    }
...
bool CMasternodePing::CheckAndUpdate(CMasternode* pmn, bool fFromNewBroadcast, int& nDos)
{
    ...
    // check the certificate and make sure if the masternode had registered on the HDCH center server
