...
{
    const char* pszTimestamp = "hdch hold value testnet.";
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60;                    // HDCH: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60;                         // HDCH: 2.5 minutes
        ...
        // HDCH addresses start with 'U'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,68);
        // HDCH script addresses start with 'S'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,63);
        // HDCH private keys start with '5' or 'K' or 'L'(as in Bitcoin)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,0x80);
        // HDCH BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // HDCH BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        // HDCH BIP44 coin type is '247'
        ...
        vFixedSeeds.clear();
        vSeeds.clear();		
        vSeeds.push_back(CDNSSeedData("hdch.one", "seed1.hdch.one"));
	vSeeds.push_back(CDNSSeedData("hdch.one", "seed2.hdch.one"));  
	vSeeds.push_back(CDNSSeedData("hdch.one", "seed3.hdch.one"));
	vSeeds.push_back(CDNSSeedData("hdch.one", "seed4.hdch.one"));
	vSeeds.push_back(CDNSSeedData("hdch.one", "seed5.hdch.one"));
	vSeeds.push_back(CDNSSeedData("hdch.one", "seed6.hdch.one"));
	vSeeds.push_back(CDNSSeedData("hdch.one", "seed7.hdch.one"));
	    
	uCenter = "ucenter.hdch.one";                           // for masternode verify
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("hdch.one","testnet-seed1.hdch.one"));  
	vSeeds.push_back(CDNSSeedData("hdch.one","testnet-seed2.hdch.one"));
	vSeeds.push_back(CDNSSeedData("hdch.one","testnet-seed3.hdch.one"));
        uCenter = "test-ucenter.hdch.one";                           // currently ignored

        // Testnet HDCH addresses start with 'u'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,130);
        // Testnet HDCH script addresses start with 's'
        ...
        // Testnet HDCH BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet HDCH BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
        // Testnet HDCH BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams() {
        ...
        // Regtest HDCH addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest HDCH script addresses start with 'q'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,120);
        // Regtest private keys start with 'm'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,0xef);
        // Regtest HDCH BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest HDCH BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
        // Regtest HDCH BIP44 coin type is '1' (All coin's testnet default)
        base58Prefixes[EXT_COIN_TYPE]  = boost::assign::list_of(0x80)(0x00)(0x00)(0x01).convert_to_container<std::vector<unsigned char> >();
