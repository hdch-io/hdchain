...
// Copyright (c) 2016-2018 HDCH Foundation Ltd.
...
UniValue getnewaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "\nReturns a new HDCH address for receiving payments.\n"
            "If 'account' is specified (DEPRECATED), it is added to the address book \n"
            "so payments received with the address will be credited to 'account'.\n"
            "\nArguments:\n"
            "1. \"account\"        (string, optional) DEPRECATED. The account name for the address to be linked to. If not provided, the default account \"\" is used. It can also be set to the empty string \"\" to represent the default account. The account does not need to exist, it will be created if there is no account by the given name.\n"
            "\nResult:\n"
            "\"hdchaddress\"    (string) The new hdch address\n"
            "\nExamples:\n"
...
UniValue getaccountaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nDEPRECATED. Returns the current HDCH address for receiving payments to this account.\n"
            "\nArguments:\n"
            "1. \"account\"       (string, required) The account name for the address. It can also be set to the empty string \"\" to represent the default account. The account does not need to exist, it will be created and a new address created  if there is no account by the given name.\n"
            "\nResult:\n"
            "\"hdchaddress\"   (string) The account hdch address\n"
            "\nExamples:\n"
...
UniValue getrawchangeaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "getrawchangeaddress\n"
            "\nReturns a new HDCH address, for receiving change.\n"
...
UniValue setaccount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            "setaccount \"hdchaddress\" \"account\"\n"
            "\nDEPRECATED. Sets the account associated with the given address.\n"
            "\nArguments:\n"
            "1. \"hdchaddress\"  (string, required) The hdch address to be associated with an account.\n"
    ...
    if (!address.IsValid())
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid HDCH address");
...
UniValue getaccount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "getaccount \"hdchaddress\"\n"
            "\nDEPRECATED. Returns the account associated with the given address.\n"
            "\nArguments:\n"
            "1. \"hdchaddress\"  (string, required) The hdch address for account lookup.\n"
            "\nResult:\n"
...
UniValue getaddressesbyaccount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "  \"hdchaddress\"  (string) a hdch address associated with the given account\n"
            "  ,...\n"
            "]\n"
            "\nExamples:\n"
...
{   
    ...
    throw runtime_error(
        "claimname \"name\" \"hdchaddress\" \"amount\"\n"
        ...
        "2. \"hdchaddress\"  (string, required) The hdch address for bind accountname.\n"
        "3. \"amount\"  (numeric, required) The amount in HDCH to send. eg 10\n"
        "\nResult:\n"
	...
	{
	    throw JSONRPCError(RPC_ACCOUNTNAME_TOO_LONG, "Invalid HDCH account_name ,it is too long");
	}
...
{   
    ...
    if ( fHelp || params.size() != 3 )
     throw runtime_error(
        ...
        "3.  \"amount\"  (numeric, required) The amount in HDCH to use to bid for the name. eg 0.1\n"
        "\nResult:\n"
...
{   
    ...
    if ( fHelp || params.size() != 3)
    throw runtime_error(
        "abandonclaim \"txid\" \"hdchaddress\" \"amount\"\n"
        "Create a transaction which spends a txout which assigned a value to a name, effectively abandoning that claim.\n"
        + HelpRequiringPassphrase() +
        "\nArguments:\n"
        "1. \"txid\"  (string, required) The transaction containing the unspent txout which should be spent.\n"
        "2. \"hdchaddress\"  (string, required) The hdch address to send to.\n"
        "3. \"amount\"  (numeric, required) The amount to send to the hdch address. eg 0.1\n"
        "\nResult:\n"
        "\"transactionid\"  (string) The new transaction id.\n"
	"\nExamples:\n"
...
{   
    ...
    if ( fHelp || params.size() > 3 )
        ...
        "    \"address\":\"hdchaddress\",  (string) The hdch address of the transaction.\n"
...
{   
    ...
    if ( fHelp || params.size() != 3 )
        throw runtime_error(
            "abandonsupport \"txid\" \"hdchaddress\" \"amount\"\n"
...
UniValue sendtoaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 7)
        throw runtime_error(
            "sendtoaddress \"hdchaddress\" amount ( \"comment\" \"comment-to\" subtractfeefromamount use_is use_ps )\n"
            "\nSend an amount to a given address.\n"
            + HelpRequiringPassphrase() +
            "\nArguments:\n"
            "1. \"hdchaddress\"  (string, required) The hdch address to send to.\n"
...
UniValue sendalltoaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 5)
        throw runtime_error(
            "sendalltoaddress \"hdchaddress\" ( \"comment\" \"comment-to\" use_is use_ps )\n"
...
UniValue sendallfromAtoB(const UniValue &params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 4)
        throw std::runtime_error(
            ...
            HelpRequiringPassphrase() + "\nArguments:\n"
            "1. \"from\"                (string,"
            "required) The hdch address to send"
            "from.\n"
            "2. \"to\"                  (string,"
            "required) The hdch address to send"
            "to.\n"
...
UniValue instantsendtoaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 5)
        throw runtime_error(
            "instantsendtoaddress \"hdchaddress\" amount ( \"comment\" \"comment-to\" subtractfeefromamount )\n"
...
UniValue listaddressgroupings(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp)
        throw runtime_error(
            ...
            "  [\n"
            "    [\n"
            "      \"hdchaddress\",     (string) The hdch address\n"
...
UniValue listaddressbalances(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            ...
            "\nResult:\n"
            "{\n"
            "  \"address\": amount,       (string) The hdch address and the amount in " + CURRENCY_UNIT + "\n"
            "  ,...\n"
            "}\n"
            "\nExamples:\n"
...
UniValue signmessage(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 2)
        throw runtime_error(
            "signmessage \"hdchaddress\" \"message\"\n"
            "\nSign a message with the private key of an address"
            + HelpRequiringPassphrase() + "\n"
            "\nArguments:\n"
            "1. \"hdchaddress\"  (string, required) The hdch address to use for the private key.\n"
...
UniValue getreceivedbyaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            "getreceivedbyaddress \"hdchaddress\" ( minconf )\n"
            "\nReturns the total amount received by the given hdchaddress in transactions with at least minconf confirmations.\n"
            "\nArguments:\n"
            "1. \"hdchaddress\"  (string, required) The hdch address for transactions.\n"
...
UniValue sendfrom(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 3 || params.size() > 6)
        throw runtime_error(
            "sendfrom \"fromaccount\" \"tohdchaddress\" amount ( minconf \"comment\" \"comment-to\" )\n"
            "\nDEPRECATED (use sendtoaddress). Sent an amount from an account to a hdch address."
            + HelpRequiringPassphrase() + "\n"
            "\nArguments:\n"
            "1. \"fromaccount\"       (string, required) The name of the account to send funds from. May be the default account using \"\".\n"
            "2. \"tohdchaddress\"  (string, required) The hdch address to send funds to.\n"
...
UniValue sendmany(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 7)
        throw runtime_error(
            ...
            "    {\n"
            "      \"address\":amount   (numeric or string) The hdch address is the key, the numeric amount (can be string) in " + CURRENCY_UNIT + " is the value\n"
            "      ,...\n"
            "    }\n"
            ...
            "                           Those recipients will receive less hdchs than you enter in their corresponding amount field.\n"
    ...
    BOOST_FOREACH(const string& name_, keys)
    {
        ...
        if (!address.IsValid())
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, string("Invalid HDCH address: ")+name_);
...
UniValue addmultisigaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 3)
    {
        string msg = "addmultisigaddress nrequired [\"key\",...] ( \"account\" )\n"
            ...
            "Each key is a HDCH address or hex-encoded public key.\n"
            "If 'account' is specified (DEPRECATED), assign address to that account.\n"

            "\nArguments:\n"
            "1. nrequired        (numeric, required) The number of required signatures out of the n keys or addresses.\n"
            "2. \"keysobject\"   (string, required) A json array of hdch addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"address\"  (string) hdch address or hex-encoded public key\n"
            "       ...,\n"
            "     ]\n"
            "3. \"account\"      (string, optional) DEPRECATED. An account to assign the addresses to.\n"

            "\nResult:\n"
            "\"hdchaddress\"  (string) A hdch address associated with the keys.\n"
...
UniValue listtransactions(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 4)
        throw runtime_error(
            ...
            "                                                It will be \"\" for the default account.\n"
            "    \"address\":\"hdchaddress\",    (string) The hdch address of the transaction. Not present for \n"
...
UniValue listsinceblock(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp)
        throw runtime_error(
            ...
            "    \"address\":\"hdchaddress\",    (string) The hdch address of the transaction. Not present for move transactions (category = move).\n"
...
UniValue gettransaction(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "      \"address\" : \"hdchaddress\",   (string) The hdch address involved in the transaction\n"
...
UniValue walletpassphrase(const UniValue& params, bool fHelp)
{
    ...
    if (pwalletMain->IsCrypted() && (fHelp || params.size() < 2 || params.size() > 3))
        throw runtime_error(
            ...
            "This is needed prior to performing transactions related to private keys such as sending hdchs\n"
            "\nArguments:\n"
...
UniValue encryptwallet(const UniValue& params, bool fHelp)
{
    ...
    if (!pwalletMain->IsCrypted() && (fHelp || params.size() != 1))
        throw runtime_error(
            ...
            "\nNow set the passphrase to use the wallet, such as for signing or sending hdch\n"
            + HelpExampleCli("walletpassphrase", "\"my pass phrase\"") +
            "\nNow we can so something like sign\n"
            + HelpExampleCli("signmessage", "\"hdchaddress\" \"test message\"") +
    ...
    StartShutdown();
    return "Wallet encrypted; HDCH Core server stopping, restart to run with encrypted wallet. The keypool has been flushed, you need to make a new backup.";
}
...
UniValue lockunspent(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "A locked transaction output will not be chosen by automatic coin selection, when spending hdchs.\n"
...
UniValue listunspent(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 3)
        throw runtime_error(
            ...
            "3. \"addresses\"    (string) A json array of hdch addresses to filter\n"
            "    [\n"
            "      \"address\"   (string) hdch address\n"
            "      ,...\n"
            "    ]\n"
            "\nResult\n"
            ...
            "    \"vout\" : n,               (numeric) the vout value\n"
            "    \"address\" : \"address\",  (string) the hdch address\n"
    ...
    if (params.size() > 2) {
        ...
        for (unsigned int idx = 0; idx < inputs.size(); idx++) {
            ...
            if (!address.IsValid())
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, string("Invalid HDCH address: ")+input.get_str());
            if (setAddress.count(address))
...
UniValue sendtoaccountname(const UniValue &params, bool fHelp)
{
	 if (fHelp ||  params.size() != 2)
        ...
        + HelpRequiringPassphrase() +
        "\nArguments:\n"
        "1. \"accountname\"  (string, required) The accountname of hdch chain.\n"
        "2. \"amount\"  (numeric, required) The amount in HDCH to send. eg less than 1000UT\n"
        "\nResult:\n"
        "\"transactionid\"  (string) The transaction id.\n"
        "\nExamples:\n"
