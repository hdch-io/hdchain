...
BOOST_AUTO_TEST_CASE(addrman_simple)
{
    ...
    CNetAddr source = CNetAddr("252.2.2.2:9888");
    ...
    CService addr1 = CService("250.1.1.1:9888");
    addrman.Add(CAddress(addr1), source);
    BOOST_CHECK(addrman.size() == 1);
    CAddrInfo addr_ret1 = addrman.Select();
    BOOST_CHECK(addr_ret1.ToString() == "250.1.1.1:9888");

    // Test 3: Does IP address deduplication work correctly. 
    //  Expected dup IP should not be added.
    CService addr1_dup = CService("250.1.1.1:9888");
    ...
    //  have two addrs.
    CService addr2 = CService("250.1.1.2:9888");
...
BOOST_AUTO_TEST_CASE(addrman_ports)
{
    ...
    BOOST_CHECK(addr_ret2.ToString() == "250.1.1.1:9888");
    ...
    BOOST_CHECK(addr_ret3.ToString() == "250.1.1.1:9888");
}
