...
BOOST_AUTO_TEST_CASE(suhdch_test)
{
    ...
    // Invalid suhdchs Match nothing (not even invalid addresses)
    ...
    CSubNet suhdch = CSubNet("1.2.3.4/255.255.255.255");
    BOOST_CHECK_EQUAL(suhdch.ToString(), "1.2.3.4/32");
    suhdch = CSubNet("1.2.3.4/255.255.255.254");
    BOOST_CHECK_EQUAL(suhdch.ToString(), "1.2.3.4/31");
    suhdch = CSubNet("1.2.3.4/255.255.255.252");
    BOOST_CHECK_EQUAL(suhdch.ToString(), "1.2.3.4/30");
    suhdch = CSubNet("1.2.3.4/255.255.255.248");
    BOOST_CHECK_EQUAL(suhdch.ToString(), "1.2.3.0/29");
    suhdch = CSubNet("1.2.3.4/255.255.255.240");
    BOOST_CHECK_EQUAL(suhdch.ToString(), "1.2.3.0/28");
    suhdch = CSubNet("1.2.3.4/255.255.255.224");
    BOOST_CHECK_EQUAL(suhdch.ToString(), "1.2.3.0/27");
    suhdch = CSubNet("1.2.3.4/255.255.255.192");
    BOOST_CHECK_EQUAL(suhdch.ToString(), "1.2.3.0/26");
    suhdch = CSubNet("1.2.3.4/255.255.255.128");
    BOOST_CHECK_EQUAL(suhdch.ToString(), "1.2.3.0/25");
    suhdch = CSubNet("1.2.3.4/255.255.255.0");
    BOOST_CHECK_EQUAL(suhdch.ToString(), "1.2.3.0/24");
    suhdch = CSubNet("1.2.3.4/255.255.254.0");
    BOOST_CHECK_EQUAL(suhdch.ToString(), "1.2.2.0/23");
    suhdch = CSubNet("1.2.3.4/255.255.252.0");
    BOOST_CHECK_EQUAL(suhdch.ToString(), "1.2.0.0/22");
    suhdch = CSubNet("1.2.3.4/255.255.248.0");
    BOOST_CHECK_EQUAL(suhdch.ToString(), "1.2.0.0/21");
    suhdch = CSubNet("1.2.3.4/255.255.240.0");
    BOOST_CHECK_EQUAL(suhdch.ToString(), "1.2.0.0/20");
    suhdch = CSubNet("1.2.3.4/255.255.224.0");
    BOOST_CHECK_EQUAL(suhdch.ToString(), "1.2.0.0/19");
    suhdch = CSubNet("1.2.3.4/255.255.192.0");
    BOOST_CHECK_EQUAL(suhdch.ToString(), "1.2.0.0/18");
    suhdch = CSubNet("1.2.3.4/255.255.128.0");
    BOOST_CHECK_EQUAL(suhdch.ToString(), "1.2.0.0/17");
    suhdch = CSubNet("1.2.3.4/255.255.0.0");
    BOOST_CHECK_EQUAL(suhdch.ToString(), "1.2.0.0/16");
    suhdch = CSubNet("1.2.3.4/255.254.0.0");
    BOOST_CHECK_EQUAL(suhdch.ToString(), "1.2.0.0/15");
    suhdch = CSubNet("1.2.3.4/255.252.0.0");
    BOOST_CHECK_EQUAL(suhdch.ToString(), "1.0.0.0/14");
    suhdch = CSubNet("1.2.3.4/255.248.0.0");
    BOOST_CHECK_EQUAL(suhdch.ToString(), "1.0.0.0/13");
    suhdch = CSubNet("1.2.3.4/255.240.0.0");
    BOOST_CHECK_EQUAL(suhdch.ToString(), "1.0.0.0/12");
    suhdch = CSubNet("1.2.3.4/255.224.0.0");
    BOOST_CHECK_EQUAL(suhdch.ToString(), "1.0.0.0/11");
    suhdch = CSubNet("1.2.3.4/255.192.0.0");
    BOOST_CHECK_EQUAL(suhdch.ToString(), "1.0.0.0/10");
    suhdch = CSubNet("1.2.3.4/255.128.0.0");
    BOOST_CHECK_EQUAL(suhdch.ToString(), "1.0.0.0/9");
    suhdch = CSubNet("1.2.3.4/255.0.0.0");
    BOOST_CHECK_EQUAL(suhdch.ToString(), "1.0.0.0/8");
    suhdch = CSubNet("1.2.3.4/254.0.0.0");
    BOOST_CHECK_EQUAL(suhdch.ToString(), "0.0.0.0/7");
    suhdch = CSubNet("1.2.3.4/252.0.0.0");
    BOOST_CHECK_EQUAL(suhdch.ToString(), "0.0.0.0/6");
    suhdch = CSubNet("1.2.3.4/248.0.0.0");
    BOOST_CHECK_EQUAL(suhdch.ToString(), "0.0.0.0/5");
    suhdch = CSubNet("1.2.3.4/240.0.0.0");
    BOOST_CHECK_EQUAL(suhdch.ToString(), "0.0.0.0/4");
    suhdch = CSubNet("1.2.3.4/224.0.0.0");
    BOOST_CHECK_EQUAL(suhdch.ToString(), "0.0.0.0/3");
    suhdch = CSubNet("1.2.3.4/192.0.0.0");
    BOOST_CHECK_EQUAL(suhdch.ToString(), "0.0.0.0/2");
    suhdch = CSubNet("1.2.3.4/128.0.0.0");
    BOOST_CHECK_EQUAL(suhdch.ToString(), "0.0.0.0/1");
    suhdch = CSubNet("1.2.3.4/0.0.0.0");
    BOOST_CHECK_EQUAL(suhdch.ToString(), "0.0.0.0/0");

    suhdch = CSubNet("1:2:3:4:5:6:7:8/ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffff");
    BOOST_CHECK_EQUAL(suhdch.ToString(), "1:2:3:4:5:6:7:8/128");
    suhdch = CSubNet("1:2:3:4:5:6:7:8/ffff:0000:0000:0000:0000:0000:0000:0000");
    BOOST_CHECK_EQUAL(suhdch.ToString(), "1::/16");
    suhdch = CSubNet("1:2:3:4:5:6:7:8/0000:0000:0000:0000:0000:0000:0000:0000");
    BOOST_CHECK_EQUAL(suhdch.ToString(), "::/0");
    suhdch = CSubNet("1.2.3.4/255.255.232.0");
    BOOST_CHECK_EQUAL(suhdch.ToString(), "1.2.0.0/255.255.232.0");
    suhdch = CSubNet("1:2:3:4:5:6:7:8/ffff:ffff:ffff:fffe:ffff:ffff:ffff:ff0f");
    BOOST_CHECK_EQUAL(suhdch.ToString(), "1:2:3:4:5:6:7:8/ffff:ffff:ffff:fffe:ffff:ffff:ffff:ff0f");
}
