 ...
 *
 *   // network
 *   CHDCHNetwork lvl, network-type, network-status, network-error, milestone-status*
...
// // root node
class CHDCHNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: HDCHNetwork
// //   -- signature requirements : Key1(User)
// class CHDCHNetworkVariable : public CGovernanceObject
// {
// private:
