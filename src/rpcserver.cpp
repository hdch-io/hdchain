...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop HDCH Core server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "HDCH Core server stopping";
}
...
{ //  category              name                      actor (function)         okSafeMode
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* HDCH features */
    { "hdch",               "masternode",             &masternode,             true  },
    { "hdch",               "masternodelist",         &masternodelist,         true  },
    { "hdch",               "masternodebroadcast",    &masternodebroadcast,    true  },
    { "hdch",               "gobject",                &gobject,                true  },
    { "hdch",               "getgovernanceinfo",      &getgovernanceinfo,      true  },
    { "hdch",               "getsuperblockbudget",    &getsuperblockbudget,    true  },
    { "hdch",               "voteraw",                &voteraw,                true  },
    { "hdch",               "mnsync",                 &mnsync,                 true  },
    { "hdch",               "spork",                  &spork,                  true  },
    { "hdch",               "getpoolinfo",            &getpoolinfo,            true  },
    { "hdch",               "signmnpmessage",         &signmnpmessage,         true  },
#ifdef ENABLE_WALLET
    { "hdch",               "privatesend",            &privatesend,            false },
...
{
    return "> hdch-cli " + methodname + " " + args + "\n";
}
