    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("HDCH Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About HDCH Core"));
        ...
        ui->aboutMessage->setText(QString("<font style=\"font-size:16pt;\">%1<br></font>").arg(version)+
                       ...
                       QString("<font style=\"font-size:14pt;\">%1<br></font>").arg(tr("This is HDCH full-node wallet client").replace("\n\n", "<br>")));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
    } else if (helpMode == cmdline) {
        setWindowTitle(tr("Command-line options"));
        QString header = tr("Usage:") + "\n" +
            "  hdch-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the HDCH in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.1 UT, 1 UT, 10 UT, and 100 UT--sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("HDCH Core is shutting down...") + "<br /><br />" +
