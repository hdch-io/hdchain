...
void RPCConsole::setClientModel(ClientModel *model)
{
    ...
    if (model && clientModel->getPeerTableModel() && clientModel->getBanTableModel()) {
        ...
        ui->banlistWidget->setColumnWidth(BanTableModel::Address, BANSUHDCH_COLUMN_WIDTH);
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the HDCH Core RPC console.") + "<br>" +
...
void RPCConsole::unbanSelectedNode()
{
    ...
    CSubNet possibleSuhdch(strNode.toStdString());

    if (possibleSuhdch.IsValid())
    {
        CNode::Unban(possibleSuhdch);
        DumpBanlist();
        clientModel->getBanTableModel()->refresh();
    }
}
