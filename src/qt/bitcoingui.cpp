    ...
    platformStyle(platformStyle)
{
    ...
    // QString windowTitle = tr("HDCH Core") + " - ";
    QString windowTitle = tr("HDCH Core");
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a HDCH address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and hdch: URIs)"));
    ...
    aboutAction = new QAction(/*QIcon(":/icons/" + theme + "/about"),*/ tr("&About HDCH Core"), this);
    aboutAction->setStatusTip(tr("Show information about HDCH Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for HDCH Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your HDCH addresses to prove you own them"));
    verifyMessageAction = new QAction(/*QIcon(":/icons/" + theme + "/transaction_0"), */tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified HDCH addresses"));
    ...
    openAction->setStatusTip(tr("Open a HDCH: URI or payment request"));

    showHelpMessageAction = new QAction(/*QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), */ tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    // showHelpMessageAction->setStatusTip(tr("Show the HDCH Core help message to get a list with possible HDCH Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("HDCH Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to HDCH network", "", count));
}
...
{
    QString strTitle = tr("HDCH Core"); // default title
